...
export const PEDAL_STEPS: PedalStep[] = [
  {
    ...
    description: "기능의 목표, 범위, 요구사항, 리스크를 문서화합니다. 크로스 리뷰로 맹점을 제거합니다.",
    icon: "Map",
    color: "#00d4ff",
    details: [
      "기능 목표 및 성공 기준 정의",
  ...
  },
  {
    ...
    description: "설계 문서를 청사진 삼아 코드를 작성합니다. 별도 PEDAL 문서 없이 코드만 산출합니다.",
    icon: "Code2",
    color: "#ec4899",
    details: [
  ...
  },
  {
    ...
    description: "Engineering 문서와 실제 구현을 비교합니다. Severity-Weighted Scoring으로 품질을 측정합니다.",
    icon: "BarChart3",
    color: "#00d4ff",
    details: [
      "설계 vs 구현 갭 분석",
...
export const FEATURES: Feature[] = [
  ...
  {
    title: "Wiki SSOT",
    description: "Learn 단계마다 검증된 사실을 Wiki에 축적합니다. Agent가 다음 사이클에서 처음부터 파악하는 비효율이 사라집니다.",
    icon: "Database",
    gridSpan: "normal",
    accent: "purple",
  },
  {
    ...
    description: "Critical(×3) / Warning(×2) / Info(×1) 가중치로 품질을 수치화합니다. Critical 이슈는 무조건 Iterate를 강제합니다.",
    icon: "Gauge",
    gridSpan: "normal",
    accent: "pink",
  },
  {
    ...
    description: "Engineering 완료 후, Analyze 완료 후 두 번의 게이트에서 사람이 승인합니다. AI가 독단적으로 전체 사이클을 수행하지 않습니다.",
    icon: "ShieldCheck",
    gridSpan: "normal",
    accent: "cyan",
  },
  {
    ...
    description: "Plan과 Engineering 문서가 명확한 가이드라인을 제공하므로, 고가의 최상위 모델이 아니어도 좋은 결과를 냅니다.",
    icon: "Zap",
    gridSpan: "normal",
    accent: "purple",
  },
  {
    ...
    description: "Cursor, Gemini CLI 어디서든 동일한 워크플로를 실행합니다. 팀의 도구 선택에 제약이 없습니다.",
    icon: "Layers",
    gridSpan: "wide",
    accent: "pink",
  },
...
export const TERMINAL_LINES: TerminalLine[] = [
  ...
  { type: "command", text: "cp .cursor/rules/pedal.mdc your-project/.cursor/rules/" },
...
export const SITE_META = {
  githubUrl: "https://github.com/yunsupark1116/PEDAL",
